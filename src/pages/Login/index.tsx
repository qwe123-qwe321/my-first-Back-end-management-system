    ...
    <div 
      ...
      <div className="flex flex-row bg-gray-300 backdrop-blur-md rounded-3xl shadow-2xl overflow-hidden w-full max-w-212.5 min-h-125 border border-gray-500">
        ...
        <div className="w-full md:w-1/2 p-12 flex flex-col justify-center bg-gray-800 bg-opacity-80 rounded-r-3xl">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-500 flex items-center justify-center">欢迎登录</h1>
          ...
          >
            ...
            <Form.Item>
              <Flex justify="space-between" align="center">
                <Form.Item name="remember" valuePropName="checked" noStyle>
                  <Checkbox style={{color:'#70.7% 0.165 254.624'}}>Remember me</Checkbox>
                </Form.Item>
            ...
            <Form.Item className="mb-0">
              ...
              <div className="mt-6 text-center text-gray-300">
                Don't have an account? <a href="" className="text-blue-400 font-medium hover:text-blue-300">Register now!</a>
              </div>
            </Form.Item>
          </Form>
        </div>
